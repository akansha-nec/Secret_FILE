...
SUPER_SEECRET_VALUE = 'AKIAF6BAFJKR45SAWSZ5'
zabbix username = zabbix 
...
JiraUrl=https://jira.nectechnologies.in
username= akansha.agarwal
...
ldap_bind_dn = cn=somedev,ou=company,dc=beta,dc=com
...
L8TUnHeBAoGMAPTi6WqbVcL9Uy2qJA8fJg7oN4yQ/goOh+mlW3Fsdig0VsQjxWWI
ftb/tDv6UyHw50Ms66gT+h4dWepFVFDPb38HAhoU/RvmNCHWd33Nmhd1qf2jOQiR
Q9q2qJ0gFgLFlrbJNTOkaFni2UdJ7ySS937C2rdOm5GTOaCODl6M4UjRAoGBANwn
...
NvfK3LU+Y68hRkFNjl4G8N6RAoGBAJMmA/uaqzjU9b6zyzGjDYLRkiucPHjYiGIc
...
def send_email(username="akansha0283@gmail.com", password="Kiansh@03112020" host="smtp.gmail.com", port=687):
    # TODO: instanciate server with correct vars.
    
    ESMPRO_URL_SM6=http://172.30.66.118:8060/esmpro/loginPage.action
ESMPRO_URL_SM7 =http://172.30.66.99:21120/esmpro/Login/Index
ESMPRO_USERNAME =Administrator
ESMPRO_PASSWORD =passwd
SI_VERSION =7.0.32